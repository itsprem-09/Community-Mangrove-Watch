...
// Proxy remaining API endpoints to Python backend if needed
// Note: Main incident and prediction routes are now handled directly
app.use('/api/gee', pythonBackendProxy);
app.use('/api/ml', pythonBackendProxy);

// Legacy proxy routes (for backward compatibility)
app.use('/api/incidents', incidentRoutes);
app.use('/api/analyze-image', incidentRoutes);
app.use('/api/predict-mangrove', predictionRoutes);
